...
const PreviewMarkdown = () => {
  const markdown = `# 👋 Hi there, I'm Rachana Rotte

> Cloud-savvy full-stack engineer turning business problems into production-grade, serverless solutions

<div align="center">
  <img src="https://images.pexels.com/photos/3184405/pexels-photo-3184405.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" width="120px" style="border-radius: 50%; border: 3px solid #0021A5;" />
</div>
...
<p align="center">
  <img src="https://visitcount.itsvg.in/api?id=rotte007&icon=2&color=0" alt="Visit Counter" />
</p>
...
`;
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-8">
      <h2 className="text-2xl font-bold text-gray-900 mb-6">Markdown Preview</h2>
      
      <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 overflow-auto max-h-[800px]">
      ...
      <div className="mt-6 bg-blue-50 border border-blue-100 rounded-lg p-4">
        <h3 className="font-medium text-blue-800 mb-2">How to use this Markdown:</h3>
        <ol className="list-decimal list-inside text-blue-700 space-y-2">
          <li>Copy the entire markdown code above</li>
          <li>Go to your GitHub profile repository (usually username/username)</li>
          <li>Edit the README.md file</li>
          <li>Paste the markdown code</li>
